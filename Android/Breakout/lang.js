...
var de = {
	...
	idioma: "Sprache",
	cor: "Farbe von Ball",
	end: ["Sie haben gewonnen!", "Sie verloren!", "Partitur: ", " Punkte!"],
...
var en = {
	...
	idioma: "Language",
	cor: "Color from Ball",
	end: ["You Won!", "You Lost!", "Score: ", " Points!"],
	nX: ["Easy", "Medium", "Hard"],
...
var es = {
	...
	idioma: "Idioma",
	cor: "Color de Bola",
	end: ["¡Has ganado!", "¡Has perdido!", "¡Puntuación: ", " Puntos!"],
...
var pt = {
	...
	idioma: "Idioma",
	cor: "Cor da Bolinha",
	end: ["Você Venceu!", "Você Perdeu!", "Pontuação: ", " Pontos!"],
...
var ru = {
	...
	idioma: "язык",
	cor: "Цвет от мяча",
	end: ["Вы выиграли!", "Вы потеряли!", "Оценка: ", " Очки!"],
